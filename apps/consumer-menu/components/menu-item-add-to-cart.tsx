    ...
    <div className="fixed bottom-28 left-0 right-0 z-30 flex flex-col items-center gap-3 px-4">
      <div className="flex w-full max-w-md items-center justify-between rounded-2xl border border-chaya-border bg-chaya-surface px-4 py-3 shadow-sm dark:border-zinc-700 dark:bg-zinc-950">
        ...
        <div className="flex items-center gap-4">
          <button
            type="button"
            className="flex h-10 w-10 items-center justify-center rounded-full bg-zinc-200 text-lg font-bold text-zinc-800 dark:bg-zinc-800 dark:text-zinc-100"
      ...
      <button
        type="button"
        onClick={addAndGo}
        className="w-full max-w-md rounded-2xl bg-chaya-primary px-6 py-4 text-lg font-bold text-chaya-on-primary shadow-md"
      >
        장바구니에 담기
      </button>
    </div>
