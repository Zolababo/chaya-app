...
const KO: FlowMessageTree = {
  cart: {
    pageTitle: "주문 확인",
    pageIntro:
      "메뉴에서 담은 품목은 이 브라우저에만 저장됩니다. 주문을 내면 내역·합계를 확인할 수 있고, 결제는 매장 카운터에서 합니다.",
    loading: "장바구니 불러오는 중…",
    empty: "담긴 메뉴가 없습니다. 메뉴판에서 담기 또는 상세 화면에서 수량을 정한 뒤 담아 주세요.",
    emptyCta: "메뉴로 돌아가기",
    emptyCtaAria: "메뉴판으로 돌아가기",
    listLabel: "담긴 메뉴 목록",
    lineTotal: "품목 합계",
    unitPrice: "단가",
    multiply: "×",
    ...
    tableLabel: "테이블 번호",
    optional: "(선택)",
    tablePlaceholder: "예: 12",
    noteLabel: "요청사항",
    notePlaceholder: "알레르기, 덜 맵게 등",
    noteCount: "{count}/500자",
    submitHint:
      "접수 후 주문 확인·목록은 이 폰·이 브라우저에서 하단 「주문 현황」으로 보는 것이 가장 안전합니다.",
    submitPending: "주문 전송 중…",
    submit: "주방으로 주문 보내기",
    submitAriaPending: "주문 전송 중",
    storageNote: "장바구니는 가게마다 이 기기 브라우저에만 저장됩니다.",
    qtySr: "수량",
    removeAria: "장바구니에서 삭제",
  },
  orders: {
    pageTitle: "주문 현황",
    pageIntro:
  ...
  payment: {
    offlineLead: "결제는 매장 카운터에서",
    offlineRest: "해 주세요. 이 앱에서는 주문 내역과 금액만 확인합니다.",
  },
  status: {
    pending: "접수됨",
    accepted: "주문 확인",
...
const EN: FlowMessageTree = {
  cart: {
    ...
    pageIntro:
      "Items stay in this browser only. After you order, you can review totals here. Pay at the counter.",
    loading: "Loading cart…",
    empty: "Your cart is empty. Add items from the menu or item detail page.",
    emptyCta: "Back to menu",
    emptyCtaAria: "Back to menu",
    ...
    noteLabel: "Requests",
    notePlaceholder: "Allergies, spice level, etc.",
    noteCount: "{count}/500",
    submitHint: "After submitting, check status under Orders on this phone and browser.",
    submitPending: "Sending order…",
    submit: "Send to kitchen",
    submitAriaPending: "Sending order",
    storageNote: "Cart is stored per store in this browser only.",
    qtySr: "Quantity",
  ...
  payment: {
    offlineLead: "Pay at the counter",
    offlineRest: ". This app shows order details and totals only.",
  },
  status: {
    pending: "Received",
    accepted: "Confirmed",
