...
- [점주 전환 런북](./MERCHANT_MIGRATION_RUNBOOK.md)
- [앱별 진도율 스냅샷](./DELIVERY_PROGRESS.md)
- [다음 5단계 실행 로그](./NEXT5_EXECUTION_LOG.md)
- [점주 1~7단계 실행 결과](./MERCHANT_STEP1_7_EXECUTION.md)
- [베리어프리 인증 트랙](./BARRIER_FREE_CERT_TRACK.md)
- [인증 준비 패키지 인덱스](./CERT_READINESS_PACK.md)
